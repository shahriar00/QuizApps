...
import 'package:quizapps/model.dart';
...
class _MyWidgetState extends State<programing> {
  ...
  List questionbank = [
    Model.name("CSS means Cascading Style Sheets", true),
            ...
            children: [
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: Center(
                      child: Text(
                    questionbank.elementAt(counter).text,
                    style: TextStyle(
                        fontSize: 15,
              ...
              Row(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () => cheackAnswer(true, context),
                    child: Text(
                      "TRUE",
                      style: TextStyle(
                          fontSize: 15,
                  ...
                  ElevatedButton(
                    onPressed: () => cheackAnswer(false, context),
                    child: Text(
                      "FALSE",
                      style: TextStyle(
                          fontSize: 15,
